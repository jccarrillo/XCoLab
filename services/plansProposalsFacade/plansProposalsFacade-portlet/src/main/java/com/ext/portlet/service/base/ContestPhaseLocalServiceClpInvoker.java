...
public class ContestPhaseLocalServiceClpInvoker {
    ...
    public ContestPhaseLocalServiceClpInvoker() {
        ...
        _methodName618 = "getNumberOfProposalsForJudge";
