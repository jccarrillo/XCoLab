...
public class PlanMetaLocalServiceClpInvoker {
    ...
    public PlanMetaLocalServiceClpInvoker() {
        ...
        _methodParameterTypes590 = new String[] { "com.ext.portlet.model.PlanMeta" };

        _methodName591 = "unvote";

        _methodParameterTypes591 = new String[] { "com.ext.portlet.model.PlanMeta" };
    }
