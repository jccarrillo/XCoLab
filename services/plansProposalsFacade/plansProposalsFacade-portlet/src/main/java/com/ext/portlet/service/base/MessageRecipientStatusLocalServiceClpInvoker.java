...
public class MessageRecipientStatusLocalServiceClpInvoker {
    ...
    public MessageRecipientStatusLocalServiceClpInvoker() {
        ...
        _methodName666 = "countByMessageId";

        _methodParameterTypes666 = new String[] { "long" };

        _methodName667 = "findByMessageId";

        _methodParameterTypes667 = new String[] { "long", "int", "int" };

        _methodName668 = "countArchivedMessagesForUser";

        _methodParameterTypes668 = new String[] { "long" };

        _methodName669 = "findArchivedMessagesForUser";

        _methodParameterTypes669 = new String[] { "long", "int", "int" };

        _methodName670 = "countInboxMessagesForUser";

        _methodParameterTypes670 = new String[] { "long" };

        _methodName671 = "findInboxMessagesForUser";

        _methodParameterTypes671 = new String[] { "long", "int", "int" };

        _methodName672 = "findByMessageRecipient";

        _methodParameterTypes672 = new String[] { "long", "long" };

        _methodName673 = "countUnreadMessages";

        _methodParameterTypes673 = new String[] { "long" };

        _methodName674 = "didReceiveJudgeCommentForProposal";
