...
public class PlanTypeLocalServiceClpInvoker {
    ...
    public PlanTypeLocalServiceClpInvoker() {
        ...
        _methodName666 = "getDefaultPlanType";

        _methodParameterTypes666 = new String[] {  };

        _methodName667 = "getColumnsByPlanTypeId";

        _methodParameterTypes667 = new String[] { "long" };

        _methodName668 = "getAttributesByPlanTypeId";

        _methodParameterTypes668 = new String[] { "long" };

        _methodName669 = "isRegionalType";

        _methodParameterTypes669 = new String[] { "long" };

        _methodName670 = "getAvailableModels";

        _methodParameterTypes670 = new String[] { "com.ext.portlet.model.PlanType" };

        _methodName671 = "getDefaultModel";

        _methodParameterTypes671 = new String[] { "com.ext.portlet.model.PlanType" };

        _methodName672 = "getColumns";

        _methodParameterTypes672 = new String[] { "com.ext.portlet.model.PlanType" };

        _methodName673 = "getAttributes";

        _methodParameterTypes673 = new String[] { "com.ext.portlet.model.PlanType" };

        _methodName674 = "isRegional";

        _methodParameterTypes674 = new String[] { "com.ext.portlet.model.PlanType" };
    }
