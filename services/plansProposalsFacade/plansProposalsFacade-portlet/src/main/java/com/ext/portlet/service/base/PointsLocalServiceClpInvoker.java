...
public class PointsLocalServiceClpInvoker {
    ...
    public PointsLocalServiceClpInvoker() {
        ...
        _methodName666 = "getUserMaterializedPoints";

        _methodParameterTypes666 = new String[] { "long" };

        _methodName667 = "getUserHypotheticalPoints";

        _methodParameterTypes667 = new String[] { "long" };

        _methodName668 = "distributePoints";

        _methodParameterTypes668 = new String[] { "long" };

        _methodName669 = "previewMaterializedPoints";
