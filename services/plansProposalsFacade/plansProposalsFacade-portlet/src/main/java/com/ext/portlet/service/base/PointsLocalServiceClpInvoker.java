...
public class PointsLocalServiceClpInvoker {
    ...
    public PointsLocalServiceClpInvoker() {
        ...
        _methodName596 = "getUserMaterializedPoints";

        _methodParameterTypes596 = new String[] { "long" };

        _methodName597 = "getUserHypotheticalPoints";

        _methodParameterTypes597 = new String[] { "long" };

        _methodName598 = "distributePoints";

        _methodParameterTypes598 = new String[] { "long" };

        _methodName599 = "previewMaterializedPoints";
