...
public enum ProposalTab {
    ...
    EVALUATION("Evaluation", ProposalTabCanAccessAlgorithm.alwaysFalse, ProposalTabCanAccessAlgorithm.alwaysFalse, ProposalTabActivityCountAlgorithm.evaluationCommentsCount),
